...
namespace Client_Chat___Nada_Aldubaie
{
    public partial class MainForm : Form
    {
        ...
        private void BtnConnect_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Server have not Started :(");
            }
        }
        ...
        public void managePrivateChat(List<string> parts)
        {
            ...
            this.Invoke((MethodInvoker)delegate // To Write the Received data
            {
                ...
                {
                    SendInPrivateForm privateC = new SendInPrivateForm(parts[2], clientSocket, name);
                ...
                {
                    if (Application.OpenForms["SendInPrivateForm"] != null)
                    {
                        (Application.OpenForms["SendInPrivateForm"] as SendInPrivateForm).setHistory(parts[3]);
                    }
                }
        ...
        private void privateChatToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (listBox1.SelectedIndex != -1)
            {
               ...
               SendInPrivateForm privateChat = new SendInPrivateForm(clientName, clientSocket, name);
