...
{
    public partial class SendInPrivateForm : Form
    {
        ...
        public SendInPrivateForm(String friend, TcpClient c, String name)
        {
            InitializeComponent();
            clientSocket = c;
            this.friend = friend;
        ...
        private void SendInPrivateForm_Load(object sender, EventArgs e)
        {
            try
            {
